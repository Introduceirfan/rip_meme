...
<div class="max-w-xl mx-auto">
    <h1 class="text-3xl font-bold text-red-500 mb-6"> Add Meme</h1>

    <form action="/memes" method="POST" class="space-y-4">
        @csrf

        <div>
            <label class="block text-sm text-gray-400 mb-1">Nama Meme</label>
            <input type="text" name="name" required class="w-full bg-gray-700 border border-gray-400 rounded px-4 py-2 text-white">
        </div>
        ...
        <div>
            ...
            <input type="date" name="born_at" required class="w-full bg-gray-700 border border-gray-400 rounded px-4 py-2 text-white">
        </div>
        ...
        <div>
            ...
            <input type="number" min="1" max="10" name="skor_viral" required class="w-full bg-gray-700 border border-gray-400 rounded px-4 py-2 text-white">
        </div>

        <div>
            <label class="block text-sm text-gray-400 mb-1">Image URL</label>
            <input type="text" name="image_url" class="w-full bg-gray-700 border border-gray-400 rounded px-4 py-2 text-white">
        </div>
